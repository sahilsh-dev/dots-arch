...
paru -S npm github-cli tldr timeshift telegram-desktop discord libreoffice-fresh exa mpv kdeconnect nwg-look gvfs ocs-url timeshift noto-fonts ttf-fira-code ttf-firacode-nerd ttf-jetbrains-mono-nerd ttf-ms-fonts ttf-roboto tmux snapshot filelight btop pavucontrol obsidian
