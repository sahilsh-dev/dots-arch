...
groups = [
    Group("1", label="󰖟" , matches=[Match(wm_class="brave")], layout="max"),
    ...
    Group("5", label="󰈙" , matches=[Match(wm_class="libreoffice")]),
    Group("6", label="ﭮ" , matches=[Match(wm_class="discord"), Match(wm_class="timeshift-gtk")]),
    Group("7", matches=[Match(wm_class="telegram-desktop"), Match(wm_class="steam")]),
    Group("8", label="󰝚" , matches=[Match(wm_class="mpv")]),
    Group("9", label="" , matches=[Match(wm_class="pavucontrol")]),
    Group("0", label="󰯈" , matches=[Match(wm_class="")])
]
